...
public class JasperFX {
    ...
    public void show() {
        ...
        this.show((int) bounds.getWidth(), (int) bounds.getHeight(), null, Modality.NONE, StageStyle.DECORATED);
    }
        ...
        if (fileChooser.getSelectedExtensionFilter() != null && fileChooser.getSelectedExtensionFilter().getExtensions() != null) {
            ...
            try {
                if (selectedExtension.contains("*.pdf")) {
                    ...
                    ReportExporter.docx(print, file.getAbsolutePath()+".docx");
                } else if (selectedExtension.contains("*.xlsx")) {
                    ReportExporter.xlsx(print, file.getAbsolutePath()+".xlsx");
                }
            } catch (JRException e) {
                e.printStackTrace();
            }
